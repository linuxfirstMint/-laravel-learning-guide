...
// 静的コンテンツページ（クロージャで簡潔に）
Route::get('/errorfix', fn() => inertia('Errorfix/Index'));
Route::get('/bladeescape', fn() => inertia('Bladeescape/Index'));
Route::get('/refactoring', fn() => inertia('Refactoring/Index'));
Route::get('/inertia', fn() => inertia('Inertia/Index'));
